...
const inputFields = [
  { label: "Calls To Call Center", field: "callsToCallCenter" },
  { label: "Call Volume Reduction", field: "callVolumeReduction" },
  ...
  { label: "Average Call Length", field: "averageCallLength" },
