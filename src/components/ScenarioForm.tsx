...
import { ScenarioData } from "@/utils/roiCalculations";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor={`users-${scenarioNumber}`}># of Users</Label>
        <Input
          id={`users-${scenarioNumber}`}
          type="number"
          value={data.users}
      ...
      <div className="space-y-2">
        <Label htmlFor={`usesPerDay-${scenarioNumber}`}>Uses Per Day</Label>
        <Input
          id={`usesPerDay-${scenarioNumber}`}
          type="number"
          value={data.usesPerDay}
          onChange={(e) => onChange("usesPerDay", e.target.value)}
          placeholder="0"
        />
      </div>
      ...
      <div className="space-y-2">
        <Label htmlFor={`efficiency-${scenarioNumber}`}>Increase in Efficiency (seconds)</Label>
        <Input
          id={`efficiency-${scenarioNumber}`}
          type="number"
          value={data.increaseInEfficiency}
          onChange={(e) => onChange("increaseInEfficiency", e.target.value)}
          placeholder="0"
        />
      </div>
