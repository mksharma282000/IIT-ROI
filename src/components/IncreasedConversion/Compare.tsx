...
const inputFields = [
  { label: "Annual Site Profit", field: "annualSiteProfit" },
  { label: "Current Conversion Rate", field: "currentConversionRate" },
  { label: "Improved Conversion Rate", field: "improvedConversionRate" },
