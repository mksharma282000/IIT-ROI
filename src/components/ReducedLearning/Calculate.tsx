...
const SingleROICalculator = () => {
  ...
  const downloadPDF = () => {
    ...
    const inputLabels = [
      { label: "Pre-Design Drop-off Rate", value: data.changeInTimeTaken },
      { label: "Post-Design Drop-off Rate", value: data.numberOfUsers },
      { label: "Current Monthly Page Traffic", value: data.annualSalary },
      { label: "Average Order Size", value: data.daysPerYear },
